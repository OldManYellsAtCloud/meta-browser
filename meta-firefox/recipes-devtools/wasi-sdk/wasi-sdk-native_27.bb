...
OECMAKE_C_FLAGS:remove = "${HOST_CC_ARCH} -Wl,--enable-new-dtags -Wl,-rpath-link,${STAGING_LIBDIR_NATIVE} -Wl,-rpath-link,${STAGING_BASE_LIBDIR_NATIVE} -Wl,-rpath,${STAGING_LIBDIR_NATIVE} -Wl,-rpath,${STAGING_BASE_LIBDIR_NATIVE} -Wl,--allow-shlib-undefined -Wl,--dynamic-linker=${UNINATIVE_LOADER}"
OECMAKE_CXX_FLAGS:remove = "${HOST_CC_ARCH} -Wl,--enable-new-dtags -Wl,-rpath-link,${STAGING_LIBDIR_NATIVE} -Wl,-rpath-link,${STAGING_BASE_LIBDIR_NATIVE} -Wl,-rpath,${STAGING_LIBDIR_NATIVE} -Wl,-rpath,${STAGING_BASE_LIBDIR_NATIVE} -Wl,--allow-shlib-undefined -Wl,--dynamic-linker=${UNINATIVE_LOADER}"
...
#do_install:append(){
#  mv ${D}${datadir}/wasi-sysroot/* ${D}${datadir}/../
#}
...
FILES:${PN} += "${prefix}/clang-resource-dir"
